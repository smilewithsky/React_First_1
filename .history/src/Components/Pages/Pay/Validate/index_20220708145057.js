    ...
    const handleSubmit = (e) => {
        ...
        const updateData = cloneProduct.map(product => {
            if(listPayId.includes(product.id)){
                ...
                console.log("id: ", id , "typeProduct: ",typeProduct , "nameProduct: ", nameProduct , "priceProduct: ",priceProduct , "color: " , color , "image: " , image , "size: " , size , "text: " , text , "quantity: ",quantity , "headerText: ", headerText , "descriptionProduct: ",descriptionProduct );
