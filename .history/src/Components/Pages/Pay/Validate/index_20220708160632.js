...
function Validate({payList , products}){
    ...
    const handleSubmit = (e) => {
        ...
        const updateData = cloneProduct.map( product => {
            ...
            const { nameProduct: namePayList , priceProduct: pricePayList , quantity: quantityPayList , size: sizePayList , colorProduct: colorPayList , idProduct , id: idPayList , } = clonePayList

            console.log("size " ,size);
            // console.log("id ",id , "typeProduct ",typeProduct , "priceProduct ",priceProduct , "colorProduct ",colorProduct , "descriptionProduct ",descriptionProduct , "ratingProduct ",ratingProduct);
